...
public class TellstickDevice implements Comparable<TellstickDevice>, Device {
     ...
     * Usage:
     * ArrayList<TellstickDevice> devices2 = TellstickDevice.getDevices(SwitchableDeviceImpl.class,
     * DimmableDeviceImpl.class, ...etc...);
     *
     * @param type
     * @return
     * @throws SupportedMethodsException
     ...
     * Usage:
     * ArrayList<TellstickDevice> devices2 = TellstickDevice.getDevices(devices, SwitchableDeviceImpl.class,
     * DimmableDeviceImpl.class, ...etc...);
     *
     * @param allDevices ArrayList of devices for input.
     * @param type       The types , eg DimmableDeviceImpl.class , SwitchableDeviceImpl.class, BellDevice.class,
     *                       GroupDevice.class ... etc ..
     * @return
     * @throws SupportedMethodsException
     */
    @SafeVarargs
    ...
    public boolean equals(Object obj) {
        boolean res = false;
        if (obj instanceof TellstickDevice) {
            res = this.getUUId().equals(((TellstickDevice) obj).getUUId());
        }
        return res;
    }
